...
app.layout = html.Div([
    ...
    html.H1(
        "Tigo and Claro 4G Mobile Coverage Comparison - Colombia. Period: April 2025",
        style={
...
# Leer parquet procesado
    columns_needed = ['quadkey', 'geometry', 'technology','comparison','DEPTO']
    pivot_table = pd.read_parquet("processed_data_CO.parquet", columns=columns_needed)
    pivot_table = pivot_table[pivot_table["DEPTO"] == option_adm1]  # 👈 primero filtras 
...
# Filtrar GeoDataFrame por tecnología
    dff = gdf_csv[gdf_csv["DEPTO"] == option_adm1]
...
# Gráfico de una sola barra apilada (100%)
    ...
    bar_fig = go.Figure()
    categories = ['Ambos Claro + Tigo', 'Solo Tigo', 'Solo Claro']
    colors = {
        "Ambos Claro + Tigo": "gray",
        "Solo Tigo": "blue",
        "Solo Claro": "red"
    ...
    bar_fig.update_layout(
        ...
        title=dict(
        text='Coverage percentage distribution by available mobile operator',
